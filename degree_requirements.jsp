                        ...
                        <%
                            ...
                            try {
                                ...
                                if (action != null && action.equals("update")) {
                                    conn.setAutoCommit(false);
                                    PreparedStatement pstmt = conn.prepareStatement("UPDATE degree_requirements SET degree_name = ?, department_name = ?, category_name = ?, min_units = ? WHERE id = ?"); 
                                    String degree_name = request.getParameter("degree_name");
                                    String department_name = request.getParameter("department_name");
                                    String category_name = request.getParameter("category_name");
                                    pstmt.setString(1, degree_name);
